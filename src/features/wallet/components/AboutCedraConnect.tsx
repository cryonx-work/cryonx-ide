...
export const EXPLORE_ECOSYSTEM_URL =
    "https://cedrafoundation.org/ecoide_system/projects/all";
...
const educationScreens = [
    {
        ...
        Description: createHeadlessComponent(
    ...
    },
    {
        ...
        Description: createHeadlessComponent(
            ...
            "p",
            {
                children: (
                    <>
                        Cedra Connect lets you take one account across any
                        application built on Cedra.{" "}
                        <a
    ...
    const currentEducationScreen: AboutCedraConnectEducationScreen = useMemo(
        () =>
            educationScreens.map((screen, i) => ({
                ...
                next: () => {
                    setScreenIndex(
                        screenIndex === educationScreens.length
                            ? 0
                            : screenIndex + 1
                    );
                },
